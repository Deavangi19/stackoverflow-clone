...
export const api=axios.create({baseURL:"https://api-stackoverflow.onrender.com"})
...
export const logIn=(authData)=>axios.post('https://api-stackoverflow.onrender.com/api/user/login',authData)
export const signUp=(authData)=>axios.post('https://api-stackoverflow.onrender.com/api/user/signup',authData)
export const getAllUsers=()=>axios.get('https://api-stackoverflow.onrender.com/api/user/all')
...
export const getAllQuestion=()=>axios.get('https://api-stackoverflow.onrender.com/api/question/get')
